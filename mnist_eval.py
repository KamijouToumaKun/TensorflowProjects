        ...
        while True:
            with tf.Session() as sess:
                ...
                if ckpt and ckpt.model_checkpoint_path:
                    ...
                    print(epoch, sess.run(accuracy, feed_dict={X:mnist.validation.images, Y:mnist.validation.labels}))
                else:
